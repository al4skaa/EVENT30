// ── NAVBAR ──
        ...
        const proofObserver = new IntersectionObserver(entries => {
            entries.forEach(e => { if (e.isIntersecting) animateCounter(7, 1200); });
        }, { threshold: 0.4 });
        ...
        // ── GOOGLE SHEETS — remplacez l'URL ci-dessous après déploiement Apps Script ──
